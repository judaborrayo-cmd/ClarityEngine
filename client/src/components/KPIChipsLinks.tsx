        ...
        {items.map((k, i) => (
          ...
          >
            ...
            <div className="mt-2 inline-flex items-center gap-2">
              <span className="rounded-full border border-gray-200 px-2 py-0.5 text-[11px] text-gray-700" data-testid={`badge-client-${i}`}>
                {k.client}
              </span>
              {k.type && (
                <span className="rounded-full border border-gray-200 px-2 py-0.5 text-[11px] text-gray-600" data-testid={`badge-type-${i}`}>
                  {k.type}
                </span>
              )}
            </div>
