    ...
    <section id="services-at-a-glance" className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
      ...
      <div role="tablist" aria-label="Service tabs" className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((s) => {
          ...
          return (
            ...
            >
              <div>
                <h3 className="text-xl font-semibold text-gray-900" data-testid={`tab-title-${s.id}`}>{s.title}</h3>
      ...
      >
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          {/* Text area */}
          <div>
            <h3 className="text-2xl font-semibold text-gray-900" data-testid="panel-title">{active.title}</h3>
            <p className="mt-3 text-gray-800/90" data-testid="panel-description">
