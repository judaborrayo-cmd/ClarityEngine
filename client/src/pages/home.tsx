            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
              {caseStudies.map((study, index) => {
                ...
                return (
                  <article 
                    key={study.title} 
                    className={`group rounded-2xl border border-border p-6 bg-card shadow-sm hover:shadow-xl transition-all duration-500 hover:scale-102 animate-slide-in-left animate-case-study-highlight-${index + 1}`}
