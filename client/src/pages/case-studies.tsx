...
const caseStudies = [
  {
    ...
    metricValue: "Exceptional",
    metricLabel: "Growth",
    tags: ["Exceptional Growth", "Paid Media", "Creative Strategy"],
  ...
  },
  {
    ...
    metricValue: "Best-Seller",
    metricLabel: "Scaling",
    tags: ["Best-Selling Author", "Speaker Scaling", "Lisa Nichols"],
